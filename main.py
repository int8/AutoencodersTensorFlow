...
encoder_network_graph = MultiLayerPerceptron(178, [64, 32], 20)
encoder_network_graph.build_computational_graph([tf.nn.sigmoid, tf.nn.sigmoid, tf.nn.sigmoid])

decoder_network_graph = MultiLayerPerceptron(20, [32],  178, encoder_network_graph.get_network_output())
...
for similarity in similarities:
    ...
    expertiment_results = run_wine_experiment_sparsity_hoyer(similarity,encoder_network_graph, decoder_network_graph,  10 , 9000)
